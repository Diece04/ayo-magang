    ...
    if ($nama === '' || $nim === '') {
        ...
        try {
            $stmt = $pdo->prepare("
                ...
                WHERE id = ?
            ");
            $stmt->execute([$nama, $nim, $alamat, $mahasiswa_id]);
...
<head>
    ...
    <title>Edit Data Mahasiswa - Ayo Magang</title>
                            ...
                            <div class="col-md-8">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="verifikasi_detail.php?id=<?php echo $mahasiswa['id']; ?>" class="btn btn-sm btn-outline-secondary">Kembali</a>
                                    </div>
                                    <div class="card-body">
                                        <?php if ($error): ?>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="d-flex gap-2 mt-4">
                                                ...
                                                <a href="verifikasi_detail.php?id=<?php echo $mahasiswa['id']; ?>" class="btn btn-outline-secondary">Batal</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
